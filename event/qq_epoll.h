...
qq_int_t qq_epoll_init(qq_cycle_t *cycle);
void qq_epoll_done(qq_cycle_t *cycle);
...
qq_int_t qq_epoll_process_events(qq_cycle_t *cycle, qq_msec_t timer, qq_uint_t flags);
